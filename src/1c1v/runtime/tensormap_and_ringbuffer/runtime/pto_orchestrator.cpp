...
TaskOutputTensors PTO2OrchestratorState::submit_task(const MixedKernels &mixed_kernels, const Arg &args) {
    ...
    return submit_task_common(orch, args, active_mask, mixed_kernels.aic_kernel_id, mixed_kernels.aiv0_kernel_id);
}
...
TaskOutputTensors PTO2OrchestratorState::submit_dummy_task(const Arg &args) {
    ...
    return submit_task_common(orch, args, ActiveMask{}, INVALID_KERNEL_ID, INVALID_KERNEL_ID);
}

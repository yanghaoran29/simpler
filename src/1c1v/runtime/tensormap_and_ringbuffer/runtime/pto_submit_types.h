...
/**
 * Subtask slot count: AIC, AIV0 (1C1V: one AIV per cluster)
 */
inline constexpr int32_t PTO2_SUBTASK_SLOT_COUNT = 2;
 ...
 * requires a fully-idle cluster (1 AIC + 1 AIV).  The actual cores used
...
public:
    ...
    uint8_t core_mask() const { return raw_ & 0x03u; }

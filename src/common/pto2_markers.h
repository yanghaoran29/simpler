/*
 * PTO2 Special Instruction Markers
 *
...
#ifndef SIMPLER_SRC_COMMON_PTO2_MARKERS_H_
#define SIMPLER_SRC_COMMON_PTO2_MARKERS_H_

/* Marker flags for compilation control */

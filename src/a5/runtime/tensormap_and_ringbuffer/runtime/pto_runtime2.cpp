...
static void sync_start_capacity_impl(PTO2Runtime *rt, PTO2SyncStartCapacity *out) {
    out->aic = rt->orchestrator.total_cluster_count;
    out->mix = rt->orchestrator.total_cluster_count;
    out->aiv = rt->orchestrator.total_aiv_count;
}
...
static const PTO2RuntimeOps s_runtime_ops = {
    ...
    .sync_start_capacity = sync_start_capacity_impl,
#if SIMPLER_DFX

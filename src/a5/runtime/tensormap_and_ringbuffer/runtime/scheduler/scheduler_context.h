...
private:
    ...
    PTO2ReadyQueue *continuation_ready_queues(int32_t thread_idx) const {
    ...
    bool has_continuation_work(int32_t thread_idx) const {
        ...
        PTO2ReadyQueue *queues = continuation_ready_queues(thread_idx);
        for (int32_t shape = 0; shape < PTO2_NUM_RESOURCE_SHAPES; shape++) {
    ...
    bool has_residual_mix(int32_t thread_idx) const {
        ...
        PTO2ReadyQueue *continuation = continuation_ready_queues(thread_idx);

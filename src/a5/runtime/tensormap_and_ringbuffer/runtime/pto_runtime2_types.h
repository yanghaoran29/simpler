...
#define PTO2_MAX_RING_DEPTH (TASK_RING_SCOPE_DEPTH * TASK_RING_DOMAIN_COUNT)

// Memory pools (per-ring defaults; total = value × PTO2_MAX_RING_DEPTH)
#define PTO2_HEAP_SIZE (256 * 1024 * 1024)  // 256MB per physical ring (3GB total)
...
#define PTO2_LOCAL_CONTINUATION_QUEUE_SIZE 256
...
using TaskReadyDomain = PTO2TaskDomain;

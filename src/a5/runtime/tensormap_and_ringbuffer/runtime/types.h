...
struct Arg : TaskArgsTpl<TensorRef, uint64_t, MaxT, MaxS, TensorArgType> {
    ...
    TaskDomain task_domain_{TaskDomain::GLOBAL};
    void set_task_domain(TaskDomain domain) { task_domain_ = domain; }
    TaskDomain task_domain() const { return task_domain_; }
    ...
    void clear() {
        ...
        task_domain_ = TaskDomain::GLOBAL;
    }

/*
 * A2A3Sim instruction counting integration
 *
 * This module provides instruction counting support for the A2A3 simulator
 * using PTO2 markers and the InstrCounter class.
 *
 * SPDX-License-Identifier: Apache-2.0
 */

#ifndef SIMPLER_SRC_A2A3_PLATFORM_SIM_HOST_INSTR_COUNT_BRIDGE_H_
#define SIMPLER_SRC_A2A3_PLATFORM_SIM_HOST_INSTR_COUNT_BRIDGE_H_
...
/**
 * @brief Bridge for A2A3Sim to integrate instruction counting
 *
 * Manages instruction counting lifecycle during simulation execution
 */
class A2A3InstrCountBridge {
public:
    A2A3InstrCountBridge();
    ~A2A3InstrCountBridge();

    /**
     * @brief Initialize instruction counter for A2A3Sim
     *
     * @param num_aicpu Number of AICPU threads
     * @param num_aicore Number of AICore threads
...
#endif  // SIMPLER_SRC_A2A3_PLATFORM_SIM_HOST_INSTR_COUNT_BRIDGE_H_

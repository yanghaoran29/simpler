...
static inline PTO2TaskDomain spmd_half_domain(int64_t layer_idx, int32_t half_idx) {
    return ((layer_idx + half_idx) & 1) == 0 ? PTO2TaskDomain::DIE0 : PTO2TaskDomain::DIE1;
}
...
static inline PTO2TaskDomain mlp_shard_domain(int64_t layer_idx, int64_t shard_idx) {
...
static inline PTO2TaskId submit_mlp_spmd_half(
    int32_t func_id, int64_t layer_idx, int32_t half_idx, const ChipTensor &normed,
    const ChipTensor &weight, const ChipTensor &accumulator, int64_t k_base,
    int64_t hidden_base, PTO2TaskId dependency
) {
    CoreTaskArgs params;
        ...
        for (int64_t i = 0; i < 40; i += 1) {
            PTO2_SCOPE() {
                ...
                PTO2_SCOPE(PTO2ScopeMode::MANUAL) {
                    ...
                    PTO2TaskId q_proj_tids_inline183[2];
                    for (int32_t half = 0; half < 2; ++half) {
                    ...
                    PTO2TaskId k_proj_tids_inline136[2];
                    for (int32_t half = 0; half < 2; ++half) {
                    ...
                    PTO2TaskId v_proj_tids_inline63[2];
                    for (int32_t half = 0; half < 2; ++half) {
                    ...
                    for (int32_t half = 0; half < 2; ++half) {
                        ...
                        PTO2TaskId half_tid = rt_submit_aic_task(14, params_t13).task_id();
                    ...
                    PTO2TaskId gate_spmd_tids_inline245[2];
                    for (int32_t half = 0; half < 2; ++half) {
                        gate_spmd_tids_inline245[half] = submit_mlp_spmd_half(
                            21, i, half, mlp_norm_in_inline71, ext_w_gate, gate_acc_all_inline203,
                            gu_k0_inline131, layer_hidden_base_inline151, _submit_deps_buf_inline237[0]
                        );
                    }
                    ...
                    PTO2TaskId up_spmd_tids_inline264[2];
                    for (int32_t half = 0; half < 2; ++half) {
                        up_spmd_tids_inline264[half] = submit_mlp_spmd_half(
                            22, i, half, mlp_norm_in_inline71, ext_w_up, up_acc_all_inline303,
                            gu_k0_inline131, layer_hidden_base_inline151, _submit_deps_buf_inline260[0]
                        );
                    }
                    ...
                    PTO2TaskId gate_spmd_tids_inline245__ssa_v1[2];
                    for (int32_t half = 0; half < 2; ++half) {
                        gate_spmd_tids_inline245__ssa_v1[half] = submit_mlp_spmd_half(
                            ...
                            gu_k0_inline131__ssa_v1, layer_hidden_base_inline151,
                            _submit_deps_buf_inline237__ssa_v1[0]
                        );
                    }
                    ...
                    PTO2TaskId up_spmd_tids_inline264__ssa_v1[2];
                    for (int32_t half = 0; half < 2; ++half) {
                        up_spmd_tids_inline264__ssa_v1[half] = submit_mlp_spmd_half(
                            24, i, half, mlp_norm_in_inline71, ext_w_up, up_acc_all_inline303,
                            gu_k0_inline131__ssa_v1, layer_hidden_base_inline151,
                            _submit_deps_buf_inline260__ssa_v1[0]
                        );
                    }
                    ...
                    PTO2TaskId gate_spmd_tids_inline245__ssa_v2[2];
                    for (int32_t half = 0; half < 2; ++half) {
                        gate_spmd_tids_inline245__ssa_v2[half] = submit_mlp_spmd_half(
                            ...
                            gu_k0_inline131__ssa_v2, layer_hidden_base_inline151,
                            _submit_deps_buf_inline237__ssa_v2[0]
                        );
                    }
                    ...
                    PTO2TaskId up_spmd_tids_inline264__ssa_v2[2];
                    for (int32_t half = 0; half < 2; ++half) {
                        up_spmd_tids_inline264__ssa_v2[half] = submit_mlp_spmd_half(
                            26, i, half, mlp_norm_in_inline71, ext_w_up, up_acc_all_inline303,
                            gu_k0_inline131__ssa_v2, layer_hidden_base_inline151,
                            _submit_deps_buf_inline260__ssa_v2[0]
                        );
                    }
                    ...
                    PTO2TaskId gate_spmd_tids_inline245__ssa_v3[2];
                    for (int32_t half = 0; half < 2; ++half) {
                        gate_spmd_tids_inline245__ssa_v3[half] = submit_mlp_spmd_half(
                            ...
                            gu_k0_inline131__ssa_v3, layer_hidden_base_inline151,
                            _submit_deps_buf_inline237__ssa_v3[0]
                        );
                    }
                    ...
                    PTO2TaskId up_spmd_tids_inline264__ssa_v3[2];
                    for (int32_t half = 0; half < 2; ++half) {
                        up_spmd_tids_inline264__ssa_v3[half] = submit_mlp_spmd_half(
                            28, i, half, mlp_norm_in_inline71, ext_w_up, up_acc_all_inline303,
                            gu_k0_inline131__ssa_v3, layer_hidden_base_inline151,
                            _submit_deps_buf_inline260__ssa_v3[0]
                        );
                    }
                    ...
                    PTO2TaskId gate_spmd_tids_inline245__ssa_v4[2];
                    for (int32_t half = 0; half < 2; ++half) {
                        gate_spmd_tids_inline245__ssa_v4[half] = submit_mlp_spmd_half(
                            ...
                            gu_k0_inline131__ssa_v4, layer_hidden_base_inline151,
                            _submit_deps_buf_inline237__ssa_v4[0]
                        );
                    }
                    ...
                    PTO2TaskId up_spmd_tids_inline264__ssa_v4[2];
                    for (int32_t half = 0; half < 2; ++half) {
                        up_spmd_tids_inline264__ssa_v4[half] = submit_mlp_spmd_half(
                            30, i, half, mlp_norm_in_inline71, ext_w_up, up_acc_all_inline303,
                            gu_k0_inline131__ssa_v4, layer_hidden_base_inline151,
                            _submit_deps_buf_inline260__ssa_v4[0]
                        );
                    }
                ...
                PTO2TaskId dcr_tid = rt_submit_aiv_task(35, params_t34).task_id();

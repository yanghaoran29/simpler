...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    __gm__ TaskTensor *k_proj_inline135__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[0]);
    ...
    __gm__ TaskTensor *v_proj_inline255__ssa_v0_tensor = reinterpret_cast<__gm__ TaskTensor *>(args[1]);

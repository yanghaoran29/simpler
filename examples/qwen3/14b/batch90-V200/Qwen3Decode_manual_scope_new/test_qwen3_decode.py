...
"""Qwen3-14B batch90-V200 single-layer decode manual-scope (explicit deps).

SPMD incore kernels with per-batch attention and cos_lo/sin_hi rope (V200 layout).
"""
...
class TestQwen314bBatch90V200NewManualScopeDecode(SceneTestCase):
    RTOL = 3e-3
    ATOL = 3e-3
        ...
        "incores": [
            {
                "func_id": 0,
                "name": "rmsnorm_spmd",
                "source": "kernels/aiv/qwen3_decode_incore_0.cpp",
                "core_type": "aiv",
            ...
            },
            {
                "func_id": 1,
                "name": "q_proj_spmd",
                "source": "kernels/aic/qwen3_decode_incore_1.cpp",
                "core_type": "aic",
            ...
            },
            {
                "func_id": 2,
                "name": "k_proj_spmd",
                "source": "kernels/aic/qwen3_decode_incore_2.cpp",
                "core_type": "aic",
                "signature": [D.IN, D.IN, D.OUT],
            },
            {
                "func_id": 3,
                "name": "v_proj_spmd",
                "source": "kernels/aic/qwen3_decode_incore_3.cpp",
                "core_type": "aic",
                "signature": [D.IN, D.IN, D.OUT],
            },
            {
            ...
            },
            {
                "func_id": 6,
                "name": "qk_matmul_spmd",
                "source": "kernels/aic/qwen3_decode_incore_6.cpp",
                "core_type": "aic",
            ...
            },
            {
                "func_id": 7,
                "name": "softmax_spmd",
                "source": "kernels/aiv/qwen3_decode_incore_7.cpp",
                "core_type": "aiv",
            ...
            },
            {
                "func_id": 8,
                "name": "sv_matmul_spmd",
                "source": "kernels/aic/qwen3_decode_incore_8.cpp",
                "core_type": "aic",
                "signature": [D.OUT, D.IN, D.IN, D.IN],
            },
            {
                "func_id": 9,
                "name": "online_softmax_spmd",
                "source": "kernels/aiv/qwen3_decode_incore_9.cpp",
                "core_type": "aiv",
            ...
            },
            {
                ...
                "source": "kernels/aic/qwen3_decode_incore_10_aic.cpp",
                "core_type": "aic",
            ...
            },
            {
                ...
                "source": "kernels/aiv/qwen3_decode_incore_10_aiv.cpp",
                "core_type": "aiv",
                "signature": [D.IN, D.IN, D.IN, D.INOUT, D.OUT],
            },
            {
...
if __name__ == "__main__":
    _merge_pto2_extra_defs_qwen3_14b_v200_manual()

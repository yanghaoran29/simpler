    ...
    PTO2_SCOPE() {
            ...
            PTO2_SCOPE() {
                ...
                for (int64_t kv0 = 0; kv0 < 1024; kv0 += 256) {
                    PTO2_SCOPE() {
                        ...
                        // Task 4: k_proj_0
                        Arg params_t4;
                        params_t4.add_input(normed_tile__rv_v2);
                        params_t4.add_input(ext_wk);
                        params_t4.add_inout(k_proj__ssa_v5);
                        params_t4.add_scalar(kv_col_b);
                        params_t4.add_scalar(b0);
                        rt_submit_aic_task(4, params_t4);
                        const Tensor& k_proj__ssa_v6 = k_proj__ssa_v5;

                        // Task 5: v_proj_0
                        Arg params_t5;
                        params_t5.add_input(normed_tile__rv_v2);
                        params_t5.add_input(ext_wv);
                        params_t5.add_inout(v_proj__ssa_v5);
                        params_t5.add_scalar(kv_col_b);
                        params_t5.add_scalar(b0);
                        rt_submit_aic_task(5, params_t5);
                        const Tensor& v_proj__ssa_v6 = v_proj__ssa_v5;
                    }
                }
            }
        }
        for (int64_t b0 = 0; b0 < batch_padded; b0 += 16) {
            PTO2_SCOPE() {
                ...
                // Task 6: qk_norm
                Arg params_t6;
                params_t6.add_output(k_proj_norm);
                params_t6.add_output(q_proj_norm);
                params_t6.add_input(q_proj);
                params_t6.add_input(ext_q_norm_weight);
                params_t6.add_input(k_proj);
                params_t6.add_input(ext_k_norm_weight);
                params_t6.add_scalar(b0);
        ...
        for (int64_t b = 0; b < user_batch; b += 1) {
            PTO2_SCOPE() {
                ...
                Arg params_t7;
                params_t7.add_output(all_q_padded);
                params_t7.add_output(ext_k_cache);
                params_t7.add_output(ext_v_cache);
                params_t7.add_input(k_proj_norm);
                params_t7.add_input(cos_lo);
                params_t7.add_input(sin_lo);
                params_t7.add_input(cos_hi);
                params_t7.add_input(sin_hi);
                params_t7.add_input(v_proj);
                params_t7.add_input(q_proj_norm);
                params_t7.add_scalar(slot_block);
                params_t7.add_scalar(slot_offset);
                ...
                for (int64_t gi = 0; gi < 8; gi += 2) {
                    PTO2_SCOPE() {
                        ...
                        // Task 8: qk_matmul
                        Arg params_t8;
                        params_t8.add_output(all_raw_scores0);
                        params_t8.add_output(all_raw_scores1);
                        params_t8.add_input(ext_block_table);
                        params_t8.add_input(k_cache__rv_v4);
                        params_t8.add_input(q_padded0);
                        params_t8.add_input(q_padded1);
                        ...
                        // Task 9: softmax
                        Arg params_t9;
                        params_t9.add_output(all_cur_li0);
                        params_t9.add_output(all_cur_li1);
                        params_t9.add_output(all_cur_mi0);
                        params_t9.add_output(all_cur_mi1);
                        params_t9.add_output(all_exp_padded0);
                        params_t9.add_output(all_exp_padded1);
                        params_t9.add_input(all_raw_scores0__rv_v2);
                        params_t9.add_input(all_raw_scores1__rv_v2);
                        ...
                        // Task 10: sv_matmul
                        Arg params_t10;
                        params_t10.add_output(all_oi_tmp0);
                        params_t10.add_output(all_oi_tmp1);
                        params_t10.add_input(ext_block_table);
                        params_t10.add_input(all_exp_padded0__rv_v2);
                        params_t10.add_input(v_cache__rv_v4);
                        params_t10.add_input(all_exp_padded1__rv_v2);
                        params_t10.add_scalar(ctx_blocks);
                        params_t10.add_scalar(block_table_base);
                        params_t10.add_scalar(kvh0);
                        params_t10.add_scalar(kvh1);
                        ...
                        Arg params_t11;
                        params_t11.add_input(all_oi_tmp0__rv_v2);
                        params_t11.add_input(all_cur_mi0__rv_v2);
                        params_t11.add_input(all_cur_li0__rv_v2);
                        params_t11.add_input(all_oi_tmp1__rv_v2);
                        params_t11.add_input(all_cur_mi1__rv_v2);
                        params_t11.add_input(all_cur_li1__rv_v2);
                        params_t11.add_output(attn_row);
                        params_t11.add_scalar(ctx_blocks);
                        params_t11.add_scalar(q_base0);
                        params_t11.add_scalar(q_base1);
        ...
        for (int64_t b0 = 0; b0 < batch_padded; b0 += 16) {
            PTO2_SCOPE() {
                ...
                for (int64_t ob = 0; ob < 20; ob += 1) {
                    PTO2_SCOPE() {
                        uint32_t o_proj_chunk_fp32_ci_shapes[2] = {16, 256};
                        ...
                        // Task 12: out_proj_residual_aic
                        Arg params_t12;
                        params_t12.add_input(attn_out);
                        params_t12.add_input(ext_wo);
                        params_t12.add_inout(o_proj_chunk_fp32);
                        ...
                        Arg params_t13;
                        params_t13.add_input(ext_hidden_states);
                        params_t13.add_input(o_proj_chunk_fp32__ssa_v1);
                        params_t13.add_output(resid1_tile);
                        params_t13.add_scalar(b0);
                        params_t13.add_scalar(o0);
                        params_t13.add_scalar(cur_valid__ssa_v1);
                ...
                for (int64_t ob = 0; ob < 68; ob += 1) {
                    PTO2_SCOPE() {
                        ...
                        params_t15.add_inout(ret0__out);
                        ...
                        params_t16.add_inout(ret0__out_1);
                        ...
                        params_t17.add_inout(ret0__out_2);
                ...
                for (int64_t dob = 0; dob < 20; dob += 1) {
                    PTO2_SCOPE() {
                        ...
                        params_t19.add_output(ext_out);
                        params_t19.add_scalar(d0);
                        params_t19.add_scalar(cur_valid__ssa_v1);

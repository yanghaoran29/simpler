...
class TestQwen3DecodeManualScope(SceneTestCase):
    ...
    CALLABLE = {
        ...
        "incores": [
            ...
            {"func_id": 13, "name": "gate_proj", "source": "kernels/aic/gate_proj.cpp", "core_type": "aic", "signature": [D.IN, D.IN, D.INOUT]},
            {"func_id": 14, "name": "up_proj", "source": "kernels/aic/up_proj.cpp", "core_type": "aic", "signature": [D.IN, D.IN, D.INOUT]},
            {"func_id": 15, "name": "silu", "source": "kernels/aiv/silu.cpp", "core_type": "aiv", "signature": [D.IN, D.IN, D.INOUT]},
            {"func_id": 16, "name": "down_proj", "source": "kernels/aic/down_proj.cpp", "core_type": "aic", "signature": [D.IN, D.IN, D.INOUT]},
            {
                "func_id": 17,
    ...
    def _run_and_validate_l2(
        ...
        def _compare_with_heatmaps(test_args, golden_args, output_names, r, a):
            ...
            try:
                ...
                if not pngs and _skill_plot_golden_mismatch_path() is None:
                    print(
                        "[golden compare] heatmap script not found. Set GOLDEN_MISMATCH_HEATMAP_SCRIPT.\n",
                        file=sys.stderr,
                    )
                if mismatches:
...
if __name__ == "__main__":
    ...
    _merge_pto2_extra_defs_qwen3_14b_manual()

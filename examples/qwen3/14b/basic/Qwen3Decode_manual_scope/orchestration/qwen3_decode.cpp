...
#include "../../qwen3_14b_decode_macros.h"
...
// Per tile: Func0=rmsnorm; all Func1 (q_proj), all Func2 (k_proj), and all Func3
// (v_proj) chunks depend only on Func0 and may run in parallel within each type.
// Func4=qk_norm fans in every Func1/2/3 task id for that tile (requires
// PTO2_LARGE_EXPLICIT_DEPS at link time — see test_qwen3_decode.py).
// Func5=rope_kv_cache: no Func5-to-Func5 edges; each invocation only waits its
// tile's Func4 and the all_q_padded buffer alloc (no __chain_dep on Func5).
// out_proj_residual (mixed 10/11): each tile task waits until every online_softmax
// (Func9) across the full batch has completed (global barrier before any mixed_10).
//
// Shape/tiling constants come from ../../qwen3_14b_decode_macros.h (override via
...
void aicpu_orchestration_entry(const ChipStorageTaskArgs& orch_args) {
    ...
    PTO2_SCOPE(PTO2ScopeMode::MANUAL) {
        ...
        for (int64_t b0 = 0; b0 < batch_padded; b0 += QWEN3_BATCH_TILE) { /* tile 16 */
                ...
                // Task 4: qk_norm (depends on Func1/2/3 completion for this tile)
                Arg params_t4;
                ...
                TaskOutputTensors __rt_151 = rt_submit_aiv_task(4, params_t4);
        ...
        for (int64_t b = 0; b < user_batch; b += 1) {
                ...
                TaskOutputTensors __rt_209 = rt_submit_aiv_task(5, params_t5);
                ...
                for (int64_t gi = 0; gi < QWEN3_NUM_KV_HEADS; gi += 2) { /* 8 */
                        ...
                        TaskOutputTensors __rt_278 = rt_submit_aic_task(6, params_t6);
                        ...
                        TaskOutputTensors __rt_294 = rt_submit_aiv_task(7, params_t7);
                        ...
                        TaskOutputTensors __rt_314 = rt_submit_aic_task(8, params_t8);
                        ...
                        TaskOutputTensors __rt_330 = rt_submit_aiv_task(9, params_t9);
        ...
        std::vector<PTO2TaskId> all_func9_task_ids;
        for (size_t bb = 0; bb < static_cast<size_t>(user_batch); ++bb) {
            for (const PTO2TaskId& __tid : online_softmax_tasks_by_b[bb]) {
                all_func9_task_ids.push_back(__tid);
            }
        }
        for (int64_t b0 = 0; b0 < batch_padded; b0 += QWEN3_BATCH_TILE) { /* tile 16 */
                ...
                PTO2TaskId out_proj_mixed_tail = PTO2TaskId::invalid();
                for (int64_t ob = 0; ob < QWEN3_OUT_PROJ_OB_COUNT; ob += 1) { /* 20 */
                    
                        uint32_t gm_pipe_buffer_0_ci_shapes[1] = {QWEN3_GM_PIPE_NUMEL}; /* 32768 */
                        ...
                        // out_proj_residual for this tile: wait every online_softmax (Func9) for
                        // batch rows in [b0, b0 + cur_valid).
                        ...
                        TaskOutputTensors __rt_367 = rt_submit_task(mixed_10, params_t10);
                        __prev = __rt_367.task_id();
                        out_proj_mixed_tail = __rt_367.task_id();
                        const Tensor& resid1_tile__co_l1_rv_v1 = resid1_tile;
                    
                }

                // post_rmsnorm: depends on last mixed out_proj for this tile (chains all ob);
                // one PTO2 task id covers both AIC and AIV subtasks for that submit.
                Arg params_t11;
                params_t11.add_input(resid1_tile);
                params_t11.add_output(post_norm_tile);
                params_t11.add_input(ext_post_rms_weight);
                params_t11.add_dep(out_proj_mixed_tail);
                __chain_dep(params_t11);
                TaskOutputTensors __rt_377 = rt_submit_aiv_task(12, params_t11);
                ...
                for (int64_t ob = 0; ob < QWEN3_MLP_SILU_STEPS; ob += 1) { /* 68 */
                        ...
                        TaskOutputTensors __rt_396 = rt_submit_aic_task(13, params_t12);
                        ...
                        TaskOutputTensors __rt_405 = rt_submit_aic_task(14, params_t13);
                        ...
                        TaskOutputTensors __rt_416 = rt_submit_aiv_task(15, params_t14);
                ...
                for (int64_t dob = 0; dob < QWEN3_DOWN_OUTPUT_CHUNKS; dob += 1) { /* 20 */
                        ...
                        // Task 15: down_proj — explicit fan-in from every silu (full connection).
                        Arg params_t15;
                        ...
                        TaskOutputTensors __rt_433 = rt_submit_aic_task(16, params_t15);
                        ...
                        TaskOutputTensors __rt_444 = rt_submit_aiv_task(17, params_t16);

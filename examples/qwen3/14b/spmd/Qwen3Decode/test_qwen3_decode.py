...
# -----------------------------------------------------------------------------------------------------------
"""Qwen3-14B (SPMD emit) single-layer decode for A2A3 tensormap_and_ringbuffer.

Layout mirrors ``examples/qwen3/14b-V200/Qwen3Decode`` and binds to SPMD kernels
under ``examples/qwen3/14b-spmd`` (``qwen3_decode_incore_*.cpp`` + mixed out-proj).
"""
...
class TestQwen314bSpmdDecode(SceneTestCase):
    RTOL = 3e-3
    ATOL = 3e-3

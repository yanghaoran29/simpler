// Orchestration Function: qwen3_decode (Qwen3-14B manual-scope explicit-deps variant).
// Same source as ``14b-V200/Qwen3Decode_manual_scope/orchestration/qwen3_decode.cpp``;
// ``kernels`` is symlinked to ``14b-V200/Qwen3Decode/kernels`` (V200 tiling, 256-wide matmul tiles).

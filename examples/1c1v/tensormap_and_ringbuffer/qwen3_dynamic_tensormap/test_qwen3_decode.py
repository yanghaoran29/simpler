...
# Hook + heatmap module are vendored alongside this test under qwen3_deps/.
_DEPENDENCY_QWEN3_DIR = Path(__file__).resolve().parent / "qwen3_deps"
    ...
    CASES = [
        {
            "name": "Case1",
            "platforms": ["1c1vsim"],
            "config": {"aicpu_thread_num": 12, "block_dim": 64},

 ...
 *
 * Case: D=2, W=64,  L=64,  total=4096, avg_degree = 2*63/64   = 1.969 → "2.0"
 *
...
const DegreeTestCase PERF_CASES[DEG_CASE_COUNT] = {
    // avg_degree = 2*(64-1)/64 = 1.969 → prints "2.0"
    { "Degree-2 (W=64,  L=64,  fanout=2, tasks=4096)",  64,  64, 2, DEG_MAX_TENSOR_NELEMS },
};

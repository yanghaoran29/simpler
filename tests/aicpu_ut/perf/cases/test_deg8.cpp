 ...
 *
 * Case: D=8, W=16,  L=128, total=2048 (scaled by num_sched); dep list entries < 65536
 *
...
const DegreeTestCase PERF_CASES[DEG_CASE_COUNT] = {
    // avg_degree = 8*(128-1)/128 ≈ 7.94; L=128 keeps dep list entries (L-1)*EW*8 under 65536
    { "Degree-8 (W=16,  L=128, fanout=8, tasks=2048)",  16, 128, 8, DEG_MAX_TENSOR_NELEMS },
};

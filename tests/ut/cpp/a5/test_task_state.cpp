...
TEST_F(TaskStateTest, FinalFaninReleasePreservesExplicitReadyDie) {
    ...
    EXPECT_EQ(
        sched.domain_ready_queues[static_cast<int32_t>(TaskReadyDomain::DIE0)]
                                 [static_cast<int32_t>(PTO2ResourceShape::AIC)]
                                     .pop(),
        &slot
    );
    EXPECT_EQ(
        sched.domain_ready_queues[static_cast<int32_t>(TaskReadyDomain::DIE1)]
                                 [static_cast<int32_t>(PTO2ResourceShape::AIC)]
                                     .pop(),
        nullptr
    );

 ...
 * happens — so after the platform tensor-data wait budget (15 s onboard; see
 * inner_get_tensor_data_wait_timeout_ticks, issue #2278) the orchestrator
 * latches TENSOR_WAIT_TIMEOUT.
 *

...
static __aicore__ void softmax_prepare_n_impl(
    ...
    using GlobalDataMxN = GlobalTensor<float, Shape<1, BATCH, Q_LEN, M, N>, pto::Stride<1, M * N, M * N, N, 1>>;
    using GlobalDataMxN_bf16 =
        GlobalTensor<bfloat16_t, Shape<1, BATCH, Q_LEN, M, N>, pto::Stride<1, M * N, M * N, N, 1>>;

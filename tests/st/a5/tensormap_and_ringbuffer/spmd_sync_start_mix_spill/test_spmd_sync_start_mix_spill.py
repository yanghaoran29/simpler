...
# -----------------------------------------------------------------------------------------------------------
"""sync_start MIX per-core pending-spill on a5 (sized from available_block_dim).

A flagged AIV producer occupies all AIV cores and spins; the require_sync_start
MIX consumer (N clusters) pre-stages with AIC on idle running slots and AIVs on
